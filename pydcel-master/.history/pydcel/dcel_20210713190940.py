...
class DCEL(object):    
   ...
   # Divide the circle equally
    ...
    def handleFaces(self, switch):
        ...
        chainList = self.findChain(self.vertexList)
        print(chainList)
