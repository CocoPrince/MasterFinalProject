...
class force_directed(object):
    ...
    def handleRotateRepusive(self):
        for kCentroid, vEdgeList in self.centroidEdgeDict.items():
            ...
            while index < len(vEdgeList):
                ...
                if len(self.centroidChainDict[centroid1.identifier]) < 2 or len(self.centroidChainDict[centroid2.identifier]) < 2:
                    continue
                ...
                rotateRadian, preCentroid, postCentroid = self.rotateRepulsive(kCentroid, centroid1, centroid2, vertexListOfKCentroid)
    ...
    def rotateRepulsive(self, kCentroid, centroid1, centroid2, vertexListOfKCentroid):
         ...
         # kCentroid——centroid1与kCentroid——centroid2，以及判断哪条边逆时针上看更靠前，哪条更靠后，选逆时针是为了方便三角函数的运算
        ...
        return (realRadian - idealRadian) / 2000, preCentroid, postCentroid # TODO done. positive or negative sign
