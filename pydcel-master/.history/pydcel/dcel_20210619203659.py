...
class DCEL(object):
    ...
    def calCircleRadius(self, face_vertices):
        ...
        stand_radius = math.pow(optimal_area/math.pi, 1/3)
    ...
    def getDestinationVertices(self, edge_list, vertex):
    ...
    def handleFaces(self):
        ...
        for vertex in self.vertexList:
            ...
            destination_vertices = self.getDestinationVertices(edge_list, vertex)
