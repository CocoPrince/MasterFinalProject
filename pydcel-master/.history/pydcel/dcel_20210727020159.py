...
class DCEL(object):    
    ...
    def calEqualiteral(self, face_vertices):
        ...
        edge_length = 13 # Default length of each edge is 1
    ...
    def calCentroidAndRadius(self, face_vertices):
        ...
        stand_radius = math.pow(optimal_area/math.pi, 1/2) * 1.2 # The radius of a circle that is as large as the area of the equilateral polygon
