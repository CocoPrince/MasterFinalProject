...
class WrapperChain(object):
    ...
    def distributeOutsideDeg2Chain(self, face_cur_centroid, face_other_centroid, radius_cur, radius_other):
        self.threeSectionArc = Arc(self.chain[0], self.chain[-1])
        self.threeSectionArc.calTangencyCircleOutside(face_cur_centroid, face_other_centroid, radius_cur, radius_other)
        self.threeSectionArc.distributeOutsideDeg2Vertices(self.chain, face_cur_centroid, radius_cur)
