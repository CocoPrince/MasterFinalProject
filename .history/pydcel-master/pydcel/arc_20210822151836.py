...
class Arc(object):
    ...
    def distributeDeg2VerticesOutside(self, chain, centroid):
        ...
        dy1 = tangencyPointStart_y - centroid.y if self.deg3StartFlag == 1 else tangencyPointEnd_y - centroid.x
        dx2 = tangencyPointStart_x - centroid.x if self.deg3StartFlag != 1 else tangencyPointEnd_x - centroid.y
